...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 43
    :sswitch_0
    const-string/jumbo v29, "android.hardware.input.IInputManager"
    ...
    .line 52
    .local v23, "_result":Landroid/view/InputDevice;
    ...
    .end local v23    # "_result":Landroid/view/InputDevice;
    :sswitch_2
    const-string/jumbo v29, "android.hardware.input.IInputManager"
    ...
    .line 107
    sget-object v29, Landroid/view/InputEvent;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {v0, v8, v10}, Landroid/hardware/input/IInputManager$Stub;->getTouchCalibrationForInputDevice(Ljava/lang/String;I)Landroid/hardware/input/TouchCalibration;

    move-result-object v22

    .line 127
    .local v22, "_result":Landroid/hardware/input/TouchCalibration;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v10    # "_arg1":I
    .end local v22    # "_result":Landroid/hardware/input/TouchCalibration;
    :sswitch_7
    const-string/jumbo v29, "android.hardware.input.IInputManager"
    ...
    .line 146
    sget-object v29, Landroid/hardware/input/TouchCalibration;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    check-cast v15, Landroid/hardware/input/TouchCalibration;

    .line 151
    :goto_6
    move-object/from16 v0, p0

    invoke-virtual {v0, v8, v10, v15}, Landroid/hardware/input/IInputManager$Stub;->setTouchCalibrationForInputDevice(Ljava/lang/String;ILandroid/hardware/input/TouchCalibration;)V
    ...
    .local v15, "_arg2":Landroid/hardware/input/TouchCalibration;
    goto :goto_6

    .line 157
    .end local v8    # "_arg0":Ljava/lang/String;
    .end local v10    # "_arg1":I
    .end local v15    # "_arg2":Landroid/hardware/input/TouchCalibration;
    :sswitch_8
    const-string/jumbo v29, "android.hardware.input.IInputManager"
    ...
    .line 159
    .local v27, "_result":[Landroid/hardware/input/KeyboardLayout;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 165
    .end local v27    # "_result":[Landroid/hardware/input/KeyboardLayout;
    :sswitch_9
    const-string/jumbo v29, "android.hardware.input.IInputManager"
    ...
    .line 169
    .local v21, "_result":Landroid/hardware/input/KeyboardLayout;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 181
    .end local v8    # "_arg0":Ljava/lang/String;
    .end local v21    # "_result":Landroid/hardware/input/KeyboardLayout;
    :sswitch_a
    const-string/jumbo v29, "android.hardware.input.IInputManager"
    ...
    .line 184
    sget-object v29, Landroid/hardware/input/InputDeviceIdentifier;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-virtual {v0, v6, v12}, Landroid/hardware/input/IInputManager$Stub;->setCurrentKeyboardLayoutForInputDevice(Landroid/hardware/input/InputDeviceIdentifier;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v6, v12}, Landroid/hardware/input/IInputManager$Stub;->addKeyboardLayoutForInputDevice(Landroid/hardware/input/InputDeviceIdentifier;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v6, v12}, Landroid/hardware/input/IInputManager$Stub;->removeKeyboardLayoutForInputDevice(Landroid/hardware/input/InputDeviceIdentifier;Ljava/lang/String;)V
    ...
    invoke-static/range {v29 .. v29}, Landroid/hardware/input/IInputDevicesChangedListener$Stub;->asInterface(Landroid/os/IBinder;)Landroid/hardware/input/IInputDevicesChangedListener;
    ...
    invoke-static/range {v29 .. v29}, Landroid/hardware/input/ITabletModeChangedListener$Stub;->asInterface(Landroid/os/IBinder;)Landroid/hardware/input/ITabletModeChangedListener;
    ...
    invoke-virtual {v0, v3, v13, v14, v1}, Landroid/hardware/input/IInputManager$Stub;->vibrate(I[JILandroid/os/IBinder;)V
    ...
    invoke-virtual {v0, v9}, Landroid/hardware/input/IInputManager$Stub;->switchTouchSensitiveMode(Z)V
    ...
    invoke-virtual {v0, v9}, Landroid/hardware/input/IInputManager$Stub;->switchTouchStylusMode(Z)V
    ...
    invoke-virtual {v0, v9}, Landroid/hardware/input/IInputManager$Stub;->switchTouchWakeupMode(Z)V
